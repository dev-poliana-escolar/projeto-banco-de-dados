...
CREATE TABLE `tb_produto` (
  ...
  CONSTRAINT `tb_produto_ibfk_1` FOREIGN KEY (`pro_uni_codigo`) REFERENCES `tb_unidade_medida` (`uni_codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_venda` (
  ...
  CONSTRAINT `tb_venda_ibfk_1` FOREIGN KEY (`ven_cli_codigo`) REFERENCES `tb_cliente` (`cli_codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
